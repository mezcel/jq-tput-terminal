...
function days_untill_Epiphany {
    ...
    ## The day is transferred to a Sunday if the day falls between Jan 2-8
    ## Day of Obligation
...
function thePreviousEphany {
    ## calculate when the last epiphany was
...
function days_untill_JesusBaptism {
    ...
    ## Shift Jesus' Baptism day onto a Sunday
